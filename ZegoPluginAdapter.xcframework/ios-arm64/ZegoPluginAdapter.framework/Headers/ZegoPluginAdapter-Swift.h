...
#ifndef ZEGOPLUGINADAPTER_SWIFT_H
#define ZEGOPLUGINADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ZegoPluginAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC17ZegoPluginAdapter30ZegoSignalingInRoomTextMessage")
@interface ZegoSignalingInRoomTextMessage : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSUInteger, ZegoSignalingPluginConnectionState, open) {
  ZegoSignalingPluginConnectionStateDisconnected = 0,
  ZegoSignalingPluginConnectionStateConnecting = 1,
  ZegoSignalingPluginConnectionStateConnected = 2,
  ZegoSignalingPluginConnectionStateReconnecting = 3,
};

@class NSString;

SWIFT_PROTOCOL("_TtP17ZegoPluginAdapter31ZegoSignalingPluginEventHandler_")
@protocol ZegoSignalingPluginEventHandler
...
SWIFT_CLASS("_TtC17ZegoPluginAdapter37ZegoSignalingPluginNotificationConfig")
